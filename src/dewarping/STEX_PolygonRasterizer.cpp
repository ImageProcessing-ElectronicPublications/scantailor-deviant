 ...
 */
class stexPolygonRasterizer::Edge
{
public:
 ...
 */
class stexPolygonRasterizer::EdgeComponent
{
public:
...
class stexPolygonRasterizer::EdgeOrderY
{
public:
...
class stexPolygonRasterizer::EdgeOrderX
{
public:
    bool operator()(EdgeComponent const& lhs, EdgeComponent const& rhs) const
    {
...
class stexPolygonRasterizer::Rasterizer
{
public:
...
/*============================= stexPolygonRasterizer ===========================*/

void
stexPolygonRasterizer::fill(
    BinaryImage& image, BWColor const color,
    QPolygonF const& poly, Qt::FillRule const fill_rule)
{
    if (image.isNull())
    {
        throw std::invalid_argument("stexPolygonRasterizer: target image is null");
    }
...
void
stexPolygonRasterizer::fillExcept(
    BinaryImage& image, BWColor const color,
    QPolygonF const& poly, Qt::FillRule const fill_rule)
{
    if (image.isNull())
...
/*======================= stexPolygonRasterizer::Edge ==========================*/

stexPolygonRasterizer::Edge::Edge(
...
stexPolygonRasterizer::Edge::Edge(QPointF const& from, QPointF const& to)
{
    if (from.y() < to.y())
    {
        m_vertDirection = 1;
...
double
stexPolygonRasterizer::Edge::xForY(double y) const
{
...
/*=================== stexPolygonRasterizer::Rasterizer ====================*/

stexPolygonRasterizer::Rasterizer::Rasterizer(
...
void
stexPolygonRasterizer::Rasterizer::prepareEdges()
{
...
void
stexPolygonRasterizer::Rasterizer::fillBinary(
...
void
stexPolygonRasterizer::Rasterizer::fillGrayscale(
...
void
stexPolygonRasterizer::Rasterizer::oddEvenLineBinary(
...
void
stexPolygonRasterizer::Rasterizer::oddEvenLineGrayscale(
    EdgeComponent const* const edges, int const num_edges,
...
void
stexPolygonRasterizer::Rasterizer::windingLineBinary(
    EdgeComponent const* const edges, int const num_edges,
...
void
stexPolygonRasterizer::Rasterizer::windingLineGrayscale(
    EdgeComponent const* const edges, int const num_edges,
...
void
stexPolygonRasterizer::Rasterizer::fillBinarySegment(
